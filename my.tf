...
connection {
           type     = "ssh"
           user     = "ec2-user"
           private_key = file("C:/Users/dsb89/Downloads/cloud-key.pem")
...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/Devendra-97/Hybrid_cloud-Task-2.git  /var/www/html",
